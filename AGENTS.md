...
This project is indexed by GitNexus as **ainovel-cli-fork** (5981 symbols, 22821 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
