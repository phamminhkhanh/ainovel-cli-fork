...
Khung giữa không còn trống khi engine không stream. Nó là workspace có 4 tab:
...
| **World** | `GET /api/world` + `GET /api/characters` | world rules, timeline, compass, nhân vật chính & phụ. |
